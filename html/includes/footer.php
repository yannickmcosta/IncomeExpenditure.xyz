...
<footer class="pt-4 my-md-2 pt-md-4 border-top">
	<div class="row">
		<div class="col-md-6 col-lg">
			<h5><a href="/contact">Contact the creator</a></h5>
			<p>
				<i class="far fa-user fa-fw"></i> Yannick McCabe-Costa <span class="dotted-underline" data-toggle="tooltip" data-placement="bottom" title="Fellow of the Royal Society of Art">FRSA</span><br />
				<i class="fal fa-at fa-fw"></i> <a href="mailto:yannick@mccabecosta.com">yannick@mccabecosta.com</a><br />
				<i class="fal fa-globe fa-fw"></i> <a href="https://mccabecosta.com" target="_blank">mccabecosta.com</a><br />
		...
		<div class="col-md-3 col-md">
			...
			<ul class="list-unstyled text-small">
				...
				<li><a class="text-muted" href="#" data-toggle="modal" data-target="#dataProtectionModal">Data Protection</a></li>
				<li><a class="text-muted" href="#" data-toggle="modal" data-target="#termsModal">Terms</a></li>
			</ul>
		</div>
	</div>
	<div class="row">
